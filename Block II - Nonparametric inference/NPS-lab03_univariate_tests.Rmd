...
Let us change the setting. We have made the empirical assessments of coverage (type-I error) and power ($1 -$ type II error) for tests for two independent samples. What about the other cases?




## Exploiting (multivariate) nonparametric depths
